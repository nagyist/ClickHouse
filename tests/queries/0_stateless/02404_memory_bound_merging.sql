...
drop table if exists pr_t no delay;
drop table if exists dist_t_different_dbs no delay;
drop table if exists shard_1.t_different_dbs no delay;
drop table if exists t_different_dbs no delay;
drop table if exists dist_t no delay;
drop table if exists t no delay;
